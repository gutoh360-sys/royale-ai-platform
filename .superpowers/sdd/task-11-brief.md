...
1. Create fixture-based tests
2. Run tests
3. Commit

**Test file (`backend/tests/unit/modules/analytics/test_period_filtering.py`):**

Create comprehensive tests that validate:
- today, 7d, 30d, 90d, 12m with controlled ordered_at values
- Start inclusive, end exclusive semantics
- Timezone handling (UTC vs Sao Paulo)
- Zero results show zero (not fallback)
- Revenue only counts completed orders
- Average ticket is correct
...
**Report file:** `C:\Users\gutod\Documents\royale-platform\.superpowers\sdd\task-11-report.md`
